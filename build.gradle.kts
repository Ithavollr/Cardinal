...
val prodPlugins = runPaper.downloadPluginsSpec {
    ...
    url("https://github.com/Ifiht/Cardinal/blob/main/plugin_jars/mc1-21-4/multiverse-core-5.0.0-alpha.13.jar")
    url("https://github.com/Ifiht/Cardinal/blob/main/plugin_jars/mc1-21-4/multiverse-inventories-5.0.0-alpha.13.jar")
    url("https://github.com/Ifiht/Cardinal/blob/main/plugin_jars/mc1-21-4/multiverse-netherportals-5.0.0-alpha.13.jar")
    url("https://github.com/Ifiht/Cardinal/blob/main/plugin_jars/mc1-21-4/multiverse-portals-5.0.0-alpha.13.jar")
